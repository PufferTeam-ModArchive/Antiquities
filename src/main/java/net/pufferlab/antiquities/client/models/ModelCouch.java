...
public class ModelCouch extends ModelFurniture {
    ...
    public ModelCouch() {
        ...
        base.cubeList.add(new ModelBox(base, 0, 0, -8.0F, -10.0F + 8F, -8.0F, 16, 7, 16, 0.0F));
        base.cubeList.add(new ModelBox(base, 0, 23, -8.0F, -20.0F + 8F, 3.0F, 16, 10, 5, 0.0F));
        bb_main.addChild(base);

        leg1 = new ModelRenderer(this);
        leg1.setRotationPoint(0.0F, 0.0F, 0.0F);
        leg1.cubeList.add(new ModelBox(leg1, 0, 0, 5.0F, -3.0F + 8F, -8.0F, 3, 3, 3, 0.0F));
        bb_main.addChild(leg1);

        leg2 = new ModelRenderer(this);
        leg2.setRotationPoint(0.0F, 0.0F, 0.0F);
        leg2.cubeList.add(new ModelBox(leg2, 0, 0, -8.0F, -3.0F + 8F, -8.0F, 3, 3, 3, 0.0F));
        bb_main.addChild(leg2);

        leg3 = new ModelRenderer(this);
        leg3.setRotationPoint(0.0F, 0.0F, 0.0F);
        leg3.cubeList.add(new ModelBox(leg3, 0, 0, 5.0F, -3.0F + 8F, 5.0F, 3, 3, 3, 0.0F));
        bb_main.addChild(leg3);

        leg4 = new ModelRenderer(this);
        leg4.setRotationPoint(0.0F, 0.0F, 0.0F);
        leg4.cubeList.add(new ModelBox(leg4, 0, 0, -8.0F, -3.0F + 8F, 5.0F, 3, 3, 3, 0.0F));
        bb_main.addChild(leg4);

        side1 = new ModelRenderer(this);
        side1.setRotationPoint(0.0F, 0.0F, 0.0F);
        side1.cubeList.add(new ModelBox(side1, 0, 38, 6.0F, -14.0F + 8F, -7.5F, 4, 7, 15, 0.0F));
        bb_main.addChild(side1);

        side2 = new ModelRenderer(this);
        side2.setRotationPoint(0.0F, 0.0F, 0.0F);
        side2.cubeList.add(new ModelBox(side2, 0, 38, -10.0F, -14.0F + 8F, -7.5F, 4, 7, 15, 0.0F));
        ...
        corner1.cubeList.add(new ModelBox(corner1, 31, 28, -8.0F, -20.0F + 8F, -8.0F, 5, 10, 11, 0.0F));
        corners.addChild(corner1);

        corner2 = new ModelRenderer(this);
        corner2.setRotationPoint(0.0F, 0.0F, 0.0F);
        corner2.cubeList.add(new ModelBox(corner2, 31, 28, 3.0F, -20.0F + 8F, -8.0F, 5, 10, 11, 0.0F));
